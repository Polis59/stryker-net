...
public interface ITestingPlatformClient : IDisposable
{
    ...
    Task<ResponseListener> RunTestsAsync(Guid requestId, Func<TestNodeUpdate[], Task> action, TestNode[]? testNodes = null, TimeSpan? runTimeout = null, CancellationToken cancellationToken = default);
}
